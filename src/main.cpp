...
unsigned int nStakeTargetSpacing = 300;			// 5 minutes block spacing

int64 nChainStartTime = 1408703173;
...
const string strMessageMagic = "RootCoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = 100000;	// irrelevant
...
const int YEARLY_BLOCKCOUNT = 105120;	// 365 * 288
...
static const int64 nTargetTimespan = 10 * 60 * 5;  
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in RootCoin
    bool fStrictPayToScriptHash = true; // Always active in RootCoin
...
bool CBlock::AcceptBlock()
{
	...
	//ROOT will be pure PoW until modifier_switch_block
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RootCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1408703173; // epochtimestamp 1408703173
        ...
        assert(block.hashMerkleRoot == uint256("451a05e06b9f25ed1ad5e6a4482a0b7eaf48759ead313244335f2666b30fa4df")); //merkleroot of ROOT
